...
if %client_id:~0,2%=={{ (
	...
	echo [%date% %time%] Executing: "%script_drive%\opsi\opsi-client-agent\oca-installation-helper.exe" "--service-address "!service_address!" --client-id "!client_id!" --service-username "!client_id!" --service-password "!client_key!" --bootimage"
	"%script_drive%\opsi\opsi-client-agent\\oca-installation-helper.exe" "--service-address "!service_address!" --client-id "!client_id!" --service-username "!client_id!" --service-password "!client_key!" --bootimage"
) else (
