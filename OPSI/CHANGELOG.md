...
### Changed
- Update opsiclientd to 4.3.26.0 (Add clientconfig.smart_cache.cache_products_on_startup (default: False) configuration) (Jan Schneider <j.schneider@uib.de>)
...
### Changed
- Update opsiclientd to 4.3.25.1 (Update dependencies) (Jan Schneider <j.schneider@uib.de>)
...
- Update oca-installation-helper to 4.3.8.1 (Jan Schneider <j.schneider@uib.de>)
...
### Changed
- Update opsiclientd to 4.3.23.1 (Jan Schneider <j.schneider@uib.de>)

## [4.3.23.0-1] - 2026-08-03
